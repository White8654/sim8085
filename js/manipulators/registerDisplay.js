...
registerDisplay.updateRegisters = function (e) {
  if (!registerDisplay.doUpdates) return;

  registerDisplay.name.A.querySelector("i").textContent =
    registers.getRegister("A");
  registerDisplay.name.B.querySelector("i").textContent =
    registers.getRegister("B");
  registerDisplay.name.C.querySelector("i").textContent =
    registers.getRegister("C");
  registerDisplay.name.D.querySelector("i").textContent =
    registers.getRegister("D");
  registerDisplay.name.E.querySelector("i").textContent =
    registers.getRegister("E");
  registerDisplay.name.H.querySelector("i").textContent =
    registers.getRegister("H");
  registerDisplay.name.L.querySelector("i").textContent =
    registers.getRegister("L");
  registerDisplay.name.SP.querySelector("i").textContent =
    registers.getPair("SP");
  registerDisplay.name.PC.querySelector("i").textContent =
    registers.getPair("PC");
...
registerDisplay.setEcho = function (value) {
  ...
  } else registerDisplay.doUpdates = false;
};
